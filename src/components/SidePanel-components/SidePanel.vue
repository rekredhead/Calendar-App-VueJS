...
// Task 2: Start styling the Side Panel
// Task 3: Enable form submission to console log the data
// Task 4: Change the state of the isSidePanelOpen to false upon submission (use state passed as props)
</script>
